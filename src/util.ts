 ...
 * updated to support the different approach.
 * This and others utility functions will be added to new external library in the future.
 */
...
type GrakkitCascade = Set<((event: any) => void) | { script: (event: any) => void; priority: GrakkitPriority }>;
 ...
 */
export function listenEvent<X>(eventClass: X, ...listeners: (EventListener<X> | ScriptEventListener<X>)[]) {
